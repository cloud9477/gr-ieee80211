...
class ap1(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/cloud/sdr/cmu-ndp1.bin', False, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/cloud/sdr/cmu-ndp0.bin', False, 0, 0)
...
def main(top_block_cls=ap1, options=None):
    tb = top_block_cls()
