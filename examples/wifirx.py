...
class wifirx(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/cloud/sdr/debug_sig.bin', False)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_fastnoise_source_x_0 = analog.fastnoise_source_c(analog.GR_GAUSSIAN, 0.00001, (int(time.time()*1000%1000)), 8192)
        ...
        self.connect((self.ieee80211_signal_0, 0), (self.blocks_file_sink_0_0_0, 0))
