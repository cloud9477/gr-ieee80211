...
class wifirxcu2(gr.top_block):
    ...
    def __init__(self):
        ...
        self.network_socket_pdu_0_0 = network.socket_pdu('UDP_CLIENT', '127.0.0.1', '9527', 65535, False)
        self.ieee80211_trigger_0 = ieee80211.trigger()
        self.ieee80211_sync_0 = ieee80211.sync()
        self.ieee80211_signal2_0 = ieee80211.signal2()
        self.ieee80211_demodcu2_0 = ieee80211.demodcu2()
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee80211_demodcu2_0, 'out'), (self.network_socket_pdu_0_0, 'pdus'))
...
def main(top_block_cls=wifirxcu2, options=None):
    tb = top_block_cls()
