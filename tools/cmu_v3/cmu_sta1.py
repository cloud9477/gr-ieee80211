        ...
        if(tmpPktType == 20):
            if(tmpPktLen == 1024):
                ...
                for i in range(len(vFb)):
                    tmpH12 = vFb[i][0][0][0]
                    tmpH22 = vFb[i][0][0][1]
                    chanPkt.append(struct.pack('f',tmpH12.real)) 
                    chanPkt.append(struct.pack('f',tmpH12.imag))
                    chanPkt.append(struct.pack('f',tmpH22.real))
                    chanPkt.append(struct.pack('f',tmpH22.imag))
